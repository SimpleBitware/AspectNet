...
public sealed class AspectGenerator : ISourceGenerator
{
    ...
    public void Execute(GeneratorExecutionContext context)
    {
        ...
        diBuilder.AppendLine("using SimpleBitware.Aop.Runtime;");
        diBuilder.AppendLine("using SimpleBitware.Aop.Runtime.Aspects;");
        diBuilder.AppendLine("using SimpleBitware.Aop.Attributes;");
        diBuilder.AppendLine("using SimpleBitware.Aop.Runtime.Configuration;");
        diBuilder.AppendLine();
        diBuilder.AppendLine("namespace SimpleBitware.Aop.Runtime.Generated;");
        diBuilder.AppendLine();
        ...
        pipelineBuilder.AppendLine("using SimpleBitware.Aop.Runtime;");
        pipelineBuilder.AppendLine("using SimpleBitware.Aop.Runtime.Aspects;");
        pipelineBuilder.AppendLine("using SimpleBitware.Aop.Attributes;");
        pipelineBuilder.AppendLine("using System;");
        pipelineBuilder.AppendLine();
        pipelineBuilder.AppendLine("namespace SimpleBitware.Aop.Runtime.Generated;");
        pipelineBuilder.AppendLine();
        ...
        StringBuilder pipelineBuilder)
    {
        ...
        sb.AppendLine("using SimpleBitware.Aop.Runtime.Aspects;");
