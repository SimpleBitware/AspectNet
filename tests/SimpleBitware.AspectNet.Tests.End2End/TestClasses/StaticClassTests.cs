...
public class StaticClassTests
{
    ...
    public void Should_Weave_Static_Constructor()
    {
        ...
        {
            Instance = null,
            ClassType = typeof(StaticClass<DateTime>),
            MemberName = Constants.StaticConstructorMethodName
        };
    ...
    public void Should_Weave_StaticNullableProperty_Setter()
    {
        ...
        {
            Instance = null,
            ClassType = typeof(StaticClass<string>),
            MemberName = MemberNameHelper.PropertySetterName(nameof(StaticClass<>.StaticNullableProperty)),
            Parameters = new Dictionary<string, object?>(
                [new KeyValuePair<string, object?>(Constants.PropertySetterParameterName, null)]
            )
        };
        var activityKey = context.GetActivityKey();
        ExpectedAspectAttribute[] expectedAspectAttributes =
