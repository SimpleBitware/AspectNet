...
public class ClassWithMixMultipleAspectNetAttributeDecoratedPropertiesTests
{
    ...
    public void Should_Record_Activity_For_Get_Public_Property()
    {
        ...
        using (Assert.EnterMultipleScope())
        {
            ...
            Assert.That(activities[0].Aspect, Is.InstanceOf<ExtendedRecordActivityAttribute>());
            ...
            Assert.That(activities[4].Aspect, Is.InstanceOf<ExtendedRecordActivityAttribute>());
            ...
            Assert.That(activities[5].Aspect, Is.InstanceOf<ExtendedRecordActivityAttribute>());
            ...
            Assert.That(activities[6].Aspect, Is.InstanceOf<ExtendedRecordActivityAttribute>());
            ...
            Assert.That(activities[7].Aspect, Is.InstanceOf<ExtendedRecordActivityAttribute>());
            ...
            Assert.That(activities[10].Aspect, Is.InstanceOf<ExtendedRecordActivityAttribute>());
            ...
            Assert.That(activities[11].Aspect, Is.InstanceOf<ExtendedRecordActivityAttribute>());
